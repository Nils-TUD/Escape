...
static void cmdOpen(tFD fd);
static void cmdRead(tFD fd);
static void cmdWrite(tFD fd);
static void cmdClose(tFD fd);
static void cmdStat(tFD fd);
static void cmdSync(tFD fd);
static void cmdLink(tFD fd);
static void cmdUnlink(tFD fd);
static void cmdMkdir(tFD fd);
static void cmdRmdir(tFD fd);
static void cmdMount(tFD fd);
static void cmdUnmount(tFD fd);
