...
#define DISK_DELAY	1	/* seek start/settle + rotational delay */
#define DISK_SEEK	1	/* full disk seek time */
#define DISK_STARTUP	100	/* disk startup time (until DISK_READY) */
