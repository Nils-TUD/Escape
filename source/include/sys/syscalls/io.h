...
int sysc_eof(Thread *t,sIntrptStackFrame *stack);
...
int sysc_dup(Thread *t,sIntrptStackFrame *stack);
int sysc_redirect(Thread *t,sIntrptStackFrame *stack);
...
int sysc_mkdir(Thread *t,sIntrptStackFrame *stack);
