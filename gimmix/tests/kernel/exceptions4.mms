%
% exceptions4.mms -- test missing program-bits in rK when in user-mode
%
...
Main	SETL	$0,RV
		...
		NEG		$255,0,1
		ANDNMH	$255,#00FF		% remove program-bits
		SET		$0,#2000
		PUT		rWW,$0
		SETH	$0,#8000
		PUT		rXX,$0
...
LOOP	SET		$0,0			% program-bits not set, so it should raise an exception here
		JMP		LOOP
