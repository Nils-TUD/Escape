...
static void test_memmove(void) {
	...
	memmove(str1 + 1,str1,4);
	test_assertStr(str1,"aabc");
	test_assertStr((char*)memmove(str2,str2 + 1,3),"ef");
...
static void test_strstr(void) {
	...
	test_assertTrue(strstr(str3,"aac") == str3 + 1);
...
static void test_memmem(void) {
	...
	char str2[] = "";
	char str3[] = "aaac";
	test_caseStart("Testing memmem()");

	test_assertTrue(memmem(str1,11,"abc",3) == str1);
	test_assertTrue(memmem(str1,11,"def",3) == str1 + 4);
	test_assertTrue(memmem(str1,11,"ghi",3) == str1 + 8);
	test_assertTrue(memmem(str1,11,"a",1) == str1);
	test_assertTrue(memmem(str1,11,"abc def ghi",11) == str1);
	test_assertTrue(memmem(str1,11,"abc ghi",7) == NULL);
	test_assertTrue(memmem(str1,11,"",0) == str1);
	test_assertTrue(memmem(str1,11,"def ghi",7) == str1 + 4);
	test_assertTrue(memmem(str1,11,"g",1) == str1 + 8);
	test_assertTrue(memmem(str2,0,"abc",3) == NULL);
	test_assertTrue(memmem(str2,0,"",0) == str2);
	test_assertTrue(memmem(str3,4,"aac",3) == str3 + 1);
