...
public:
	...
	inline virtual const char* name(void) const throw () {
		return ("error");
	}
...
public:
	inline explicit logic_error(const char* arg) throw () :
		error_message(arg) {
	}
	inline virtual const char* name(void) const throw () {
		return ("logic error");
...
public:
	inline explicit domain_error(const char* arg) throw () :
		logic_error(arg) {
	}
	inline virtual const char* name(void) const throw () {
		return ("domain error");
...
public:
	inline explicit invalid_argument(const char* arg) throw () :
		logic_error(arg) {
	}
	inline virtual const char* name(void) const throw () {
...
public:
	inline explicit length_error(const char* arg) throw () :
		logic_error(arg) {
	}
	inline virtual const char* name(void) const throw () {
		return ("length error");
...
public:
	inline explicit out_of_range(const char* arg) throw () :
		logic_error(arg) {
	}
	inline virtual const char* name(void) const throw () {
		return ("out of range");
...
public:
	inline explicit runtime_error(const char* arg) throw () :
		error_message(arg) {
	}
	inline virtual const char* name(void) const throw () {
...
public:
	inline explicit range_error(const char* arg) throw () :
		runtime_error(arg) {
	}
	inline virtual const char* name(void) const throw () {
		return ("range error");
...
public:
	inline explicit overflow_error(const char* arg) throw () :
		runtime_error(arg) {
	}
	inline virtual const char* name(void) const throw () {
...
public:
	inline explicit underflow_error(const char* arg) throw () :
		runtime_error(arg) {
	}
	inline virtual const char* name(void) const throw () {
