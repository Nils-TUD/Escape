...
.set SYSCALL_SETDATARDA,		41
.set SYSCALL_GETCYCLES,			42
.set SYSCALL_SYNC,					43
.set SYSCALL_LINK,					44
.set SYSCALL_UNLINK,				45
.set SYSCALL_MKDIR,					46
.set SYSCALL_RMDIR,					47
.set SYSCALL_MOUNT,					48
.set SYSCALL_UNMOUNT,				49
.set SYSCALL_WAITCHILD,			50
.set SYSCALL_TELL,					51
.set SYSCALL_PIPE,					52
.set SYSCALL_GETCONF,				53
.set SYSCALL_VM86INT,				54
.set SYSCALL_GETWORK,				55
.set SYSCALL_ISTERM,				56
.set SYSCALL_JOIN,					57
.set SYSCALL_SUSPEND,				58
.set SYSCALL_RESUME,				59
.set SYSCALL_FSTAT,					60
.set SYSCALL_ADDREGION,			61
.set SYSCALL_SETREGPROT,		62
.set SYSCALL_NOTIFY,				63
.set SYSCALL_GETCLIENTID,		64
.set SYSCALL_WAITUNLOCK,		65
.set SYSCALL_GETENVITO,			66
.set SYSCALL_GETENVTO,			67
.set SYSCALL_SETENV,				68
