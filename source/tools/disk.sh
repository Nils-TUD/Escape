...
HDDTRACKSECS=63
HDDCYL=$MB
TOTALSECS=$(($HDDHEADS * $HDDTRACKSECS * $HDDCYL))
...
PART2BLOCKS=$(($TOTALSECS / 8))
PART3OFFSET=$(($PART2OFFSET + $PART2BLOCKS * 2))
PART3BLOCKS=$((($TOTALSECS - 2048 - ($PART1BLOCKS + $PART2BLOCKS) * 2) / 2))
