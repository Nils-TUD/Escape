...
sPCIDeviceInfo pciDevices[] = {
	...
	/* TODO { 0x3D3D, 0x3D07104c, "same as above?  I have no idea", "?" } ,*/
	...
	{ 0x8086, 0x2415, "Intel 82801DBM SM/BUS Controller 24C3", "Aureal (AD1881 SOUNDMAX) Placa Mae Asaki P3-141" } ,
...
/* 	{ 0x8086, 0x8086, "", "" } , */
	...
	/* TODO { 0x14F1, 0x50452, "1179FF31", "Conextant High Definition Audio-Venice 5045" } , */
	...
	/* TODO { 0x1002, 0x00000100, "{4D36E968-E325-11CE-BFC1-08002BE10318}", "{4D36E968-E325-11CE-BFC1-08002BE10318}" } ,*/
	{ 0x1002, 0x0B12, "ati 1900", "ati 1900" } ,
	/* TODO { 0x1002, 0x10024152, "0x1002", "0x4150" } , */
	...
	/* TODO { 0x103C, 0x0180000a, "0x00000000", "HID Keyboard Device" } , */
	...
	{ 0x103C, 0x10C1, "", "NetDrvIder Smart IRQ Router" } ,
	{ 0x103C, 0x10ED, "TopTools", "HP Communications Port" } ,
	{ 0x103C, 0x1200, "82557B", "10/100 NIC" } ,
	{ 0x103C, 0x1219, "", "NetDrvIder PCI Hot-Plug Controller" } ,
	{ 0x103C, 0x121A, "", "NetDrvIder SMIC Controller" } ,
	{ 0x103C, 0x121B, "", "NetDrvIder Legacy COM Port Decoder" } ,
	{ 0x103C, 0x121C, "", "NetDrvIder PCI COM Port Decoder" } ,
	...
	{ 0x1055, 0x0926, "I dont know pentium 133 intel   everex setpnot mx", "ISA Bridge" } ,
	...
	/* TODO { 0x134A, 0x3510A, "DTC50C18", "scsi" } , */
	{ 0x144A, 0x7230, "", "" } ,
	...
	/* TODO { 0x10B9, 0x3432423, "23128091", "131312" } , */
	{ 0x10B9, 0x5212, "M4803", "" } ,
	...
	{ 0x10DE, 0x0057, "nForce4 Ultra", "NVidia Network Bus Enumerator Description du peripherique	nVIDIA nForce4 SLI (CK8-04) - LAN Controll" } ,
