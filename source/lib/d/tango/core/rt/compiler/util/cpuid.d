...
version(D_InlineAsm_X86)
{
    ...
    // TODO we've disabled a few things here since we don't save/restore the registers for them
    
    /// Is MMX supported?
    bool mmx()                  {return false && (flags&MMX_BIT)!=0;}
    /// Is FXSR supported?
    bool fxsr()                 {return false && (flags&FXSR_BIT)!=0;}
    /// Is SSE supported?
    bool sse()                  {return false && (flags&SSE_BIT)!=0;}
    /// Is SSE2 supported?
    bool sse2()                 {return false && (flags&SSE2_BIT)!=0;}
    /// Is SSE3 supported?
    bool sse3()                 {return false && (misc&SSE3_BIT)!=0;}
    /// Is SSSE3 supported?
    bool ssse3()                {return false && (misc&SSSE3_BIT)!=0;}

    /// Is AMD 3DNOW supported?
    bool amd3dnow()             {return false && (exflags&AMD_3DNOW_BIT)!=0;}
    /// Is AMD 3DNOW Ext supported?
    bool amd3dnowExt()          {return false && (exflags&AMD_3DNOW_EXT_BIT)!=0;}
    /// Is AMD MMX supported?
    bool amdMmx()               {return false && (exflags&AMD_MMX_BIT)!=0;}
