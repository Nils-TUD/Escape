#ifndef lint
static char     rcsid[] =
"$Id: getline.c 92 2010-12-19 16:36:54Z nasmussen $";
...
/* we need stdio for getc (see fix in line 281) */
#include <stdio.h>
...
#ifdef __unix__
    /* Note: using getc() and int instead of char prevents gl_getc() from returning -1 if e.g. the
     * german s-z is pressed */
    c = getc(stdin);
