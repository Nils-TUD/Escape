...
% bietet durch [H] bei bildern die Möglichkeit die an eine bestimmte Stelle zu
% setzen
\usepackage{float}
\restylefloat{figure}
...
% ohne highlighting is auch ganz praktisch :)
...
% fix für \lstlistoflistings. quelle: http://www.komascript.de/node/477
\makeatletter
...
% subsubsections nummerieren und zum inhaltsverzeichnis hinzufügen
...
% ein bisschen weniger abstand vor sections im inhaltsverzeichnis, damits auf
% eine seite passt
%\newcommand{\msection}[1]{\addtocontents{toc}{\vspace{-1.8ex}}\section{#1}}

% sections, tabellen, bilder und listings mit 1 starten
\renewcommand*\thesection{\arabic{section}}
\renewcommand{\thetable}{\arabic{table}}
\renewcommand\thefigure{\arabic{figure}}
%\renewcommand\thelstlisting{\arabic{lstlisting}}

% einige bequemlichkeits befehle :)
...
% TODO use \part{} as first layer?
% TODO mmix is part of the mainline gcc
