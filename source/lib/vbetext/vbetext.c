...
static void vbet_drawCharLoop16(sScreenMode *mode,uint8_t *pos,uint8_t c,uint8_t *fg,uint8_t *bg);
static void vbet_drawCharLoop24(sScreenMode *mode,uint8_t *pos,uint8_t c,uint8_t *fg,uint8_t *bg);
static void vbet_drawCharLoop32(sScreenMode *mode,uint8_t *pos,uint8_t c,uint8_t *fg,uint8_t *bg);
