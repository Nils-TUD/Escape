...
public:
    ...
    // TODO Better turn a few things off here since we don't save mmx, sse, ... registers
    /// Is MMX supported?
    bool mmx()          {return false && (features&MMX_BIT)!=0;}
    /// Is SSE supported?
    bool sse()          {return false && (features&SSE_BIT)!=0;}
    /// Is SSE2 supported?
    bool sse2()         {return false && (features&SSE2_BIT)!=0;}
    /// Is SSE3 supported?
    bool sse3()         {return false && (miscfeatures&SSE3_BIT)!=0;}
    /// Is SSSE3 supported?
    bool ssse3()        {return false && (miscfeatures&SSSE3_BIT)!=0;}
    /// Is SSE4.1 supported?
    bool sse41()        {return false && (miscfeatures&SSE41_BIT)!=0;}
    /// Is SSE4.2 supported?
    bool sse42()        {return false && (miscfeatures&SSE42_BIT)!=0;}
    /// Is SSE4a supported?
    bool sse4a()        {return false && (amdmiscfeatures&SSE4A_BIT)!=0;}
    /// Is SSE5 supported?
    bool sse5()         {return false && (amdmiscfeatures&SSE5_BIT)!=0;}
    /// Is AMD 3DNOW supported?
    bool amd3dnow()     {return false && (amdfeatures&AMD_3DNOW_BIT)!=0;}
    /// Is AMD 3DNOW Ext supported?
    bool amd3dnowExt()  {return false && (amdfeatures&AMD_3DNOW_EXT_BIT)!=0;}
    /// Are AMD extensions to MMX supported?
    bool amdMmx()       {return false && (amdfeatures&AMD_MMX_BIT)!=0;}
