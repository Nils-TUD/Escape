...
namespace __cxxabiv1 {
	...
	namespace {
		...
		template<typename T>inline const T *adjust_pointer(const void *base,ptrdiff_t offset) {
	...
	inline __class_type_info::__sub_kind __class_type_info::__find_public_src (
			ptrdiff_t src2dst,const void *obj_ptr,const __class_type_info *src_type,
