...
inline ForwardIterator adjacent_find(ForwardIterator first,
		ForwardIterator last, BinaryPredicate p) {
	if (first != last)
...
inline pair<InputIterator, InputIterator> mismatch(InputIterator first1,
		InputIterator last1, InputIterator first2, BinaryPredicate comp) {
...
inline bool equal(InputIterator first1, InputIterator last1,
		InputIterator first2, BinaryPredicate comp) {
...
inline void nth_element(RandomAccessIterator first, RandomAccessIterator,
...
inline void partial_sort(RandomAccessIterator first, RandomAccessIterator,
