...
static const char *msgs[] = {
	...
	/* -9 (ERR_INV_DEVICE_NAME) */			"Invalid device name. Alphanumeric, not empty name expected!",
	/* -10 (ERR_NOT_ENOUGH_MEM) */			"Not enough memory!",
	/* -11 (ERR_DEVICE_EXISTS) */			"The device with desired name does already exist!",
	/* -12 (ERR_NOT_OWN_DEVICE) */			"The device-node is not your own!",
	...
	/* -23 (ERR_DRVUSE_SEEK) */				"seek() with SEEK_SET is not supported for channels!",
	...
	/* -45 (ERR_INVALID_DRVID) */			"Invalid device-id!",
	...
	/* -52 (ERR_APPS_CRTDRV_NO_PERM) */		"Application has no permission to create a device!",
	/* -53 (ERR_APPS_CRTFS_NO_PERM) */		"Application has no permission to create a fs!",
	/* -54 (--) */							"",
	/* -55 (ERR_APPS_DRV_NO_PERM) */		"Application has no permission to use the desired device!",
	/* -56 (--) */							"",
