...
#elif TARGET_LINUX || TARGET_OSX || TARGET_FREEBSD || TARGET_SOLARIS
    global.params.defaultlibname = "phobos2"; // phobos2
#elif TARGET_NET
#else
#error "fix this"
#endif
...
#elif TARGET_LINUX
    //============= CHANGE FOR ESCAPE =============
    // a small hack for escape. TARGET_LINUX occurrs in many files and our host-system is linux
    // anyway, so that the only necessary change is this here. therefore this way is simpler than
    // defining TARGET_ESCAPE and changing the whole dmd-source ;)
    //VersionCondition::addPredefinedGlobalIdent("Posix");
    //VersionCondition::addPredefinedGlobalIdent("linux");
    VersionCondition::addPredefinedGlobalIdent("Escape");
    //============= CHANGE FOR ESCAPE =============
