...
static void test_swapmap1(void) {
	...
	blocks[0] = swmap_alloc(1,0x00000000,1);
	blocks[1] = swmap_alloc(1,0x00001000,3);
	blocks[2] = swmap_alloc(1,0x00005000,1);
	blocks[3] = swmap_alloc(2,0x00005000,1);
	blocks[4] = swmap_alloc(2,0x00004000,1);
...
static void test_swapmap2(void) {
	...
	blocks[0] = swmap_alloc(1,0x00000000,1);
	blocks[1] = swmap_alloc(1,0x00001000,2);
	blocks[2] = swmap_alloc(1,0x00004000,1);
	blocks[3] = swmap_alloc(2,0x00005000,1);
	blocks[4] = swmap_alloc(2,0x00004000,1);
...
static void test_swapmap3(void) {
	...
	swmap_alloc(1,0x00000000,1);
	swmap_alloc(1,0x00001000,2);
	swmap_alloc(1,0x00004000,1);
	swmap_alloc(2,0x00005000,1);
	swmap_alloc(2,0x00004000,1);
...
static void test_swapmap4(void) {
	...
	blocks[0] = swmap_alloc(1,0x00000000,1);
	blocks[1] = swmap_alloc(1,0x00001000,2);
	blocks[2] = swmap_alloc(1,0x00003000,4);
	blocks[3] = swmap_alloc(2,0x00000000,1);
	blocks[4] = swmap_alloc(1,0x00008000,1);
	blocks[5] = swmap_alloc(2,0x00001000,3);
	blocks[6] = swmap_alloc(2,0x00004000,1);
	blocks[7] = swmap_alloc(3,0x00000000,1);
...
static void test_swapmap5(void) {
	...
	blocks[0] = swmap_alloc(1,0x00000000,2);
	blocks[1] = swmap_alloc(1,0x00002000,1);
	blocks[2] = swmap_alloc(2,0x00004000,1);
	blocks[3] = swmap_alloc(1,0x00004000,1);
	...
	blocks[4] = swmap_alloc(1,0x00003000,1);
	blocks[5] = swmap_alloc(2,0x00000000,1);
	blocks[6] = swmap_alloc(1,0x00008000,1);
	blocks[7] = swmap_alloc(2,0x00003000,1);
	...
	blocks[8] = swmap_alloc(2,0x00002000,1);
...
static void test_swapmap7(void) {
	...
	block = swmap_alloc(1,0x00000000,6);
