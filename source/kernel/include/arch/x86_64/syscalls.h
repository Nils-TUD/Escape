...
#define SYSC_ARG4(stack)				((stack)->rax)
#define SYSC_ARG5(stack)				(*(((ulong*)(stack)->getSP()) + 0))
#define SYSC_ARG6(stack)				(*(((ulong*)(stack)->getSP()) + 1))
#define SYSC_ARG7(stack)				(*(((ulong*)(stack)->getSP()) + 2))
