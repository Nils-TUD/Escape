...
ssize_t vfs_info_traceReadHandler(pid_t pid,A_UNUSED file_t file,sVFSNode *node,USER void *buffer,
		off_t offset,size_t count) {
...
ssize_t vfs_info_procReadHandler(pid_t pid,A_UNUSED file_t file,sVFSNode *node,USER void *buffer,
		off_t offset,size_t count) {
...
ssize_t vfs_info_threadReadHandler(pid_t pid,A_UNUSED file_t file,sVFSNode *node,USER void *buffer,
		off_t offset,size_t count) {
...
static ssize_t vfs_info_cpuReadHandler(pid_t pid,A_UNUSED file_t file,sVFSNode *node,USER void *buffer,
		off_t offset,size_t count) {
...
static ssize_t vfs_info_statsReadHandler(pid_t pid,A_UNUSED file_t file,sVFSNode *node,USER void *buffer,
		off_t offset,size_t count) {
...
static ssize_t vfs_info_memUsageReadHandler(pid_t pid,A_UNUSED file_t file,sVFSNode *node,
...
ssize_t vfs_info_regionsReadHandler(pid_t pid,A_UNUSED file_t file,sVFSNode *node,USER void *buffer,
		off_t offset,size_t count) {
...
ssize_t vfs_info_mapsReadHandler(pid_t pid,A_UNUSED file_t file,sVFSNode *node,USER void *buffer,
		off_t offset,size_t count) {
...
ssize_t vfs_info_virtMemReadHandler(pid_t pid,A_UNUSED file_t file,sVFSNode *node,USER void *buffer,
		off_t offset,size_t count) {
