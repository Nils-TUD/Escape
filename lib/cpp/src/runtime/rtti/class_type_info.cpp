...
namespace __cxxabiv1 {
	...
	bool __class_type_info::__do_catch(const type_info *thr_type,void **thr_obj,unsigned outer) const {
		if(*this == *thr_type)
			return true;
		if(outer >= 4)
			// Neither `A' nor `A *'.
	...
	bool __class_type_info::__do_dyncast (ptrdiff_t,__sub_kind access_path,
	...
	bool __class_type_info::__do_upcast (const __class_type_info *dst, const void *obj,
