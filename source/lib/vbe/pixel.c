...
static uint8_t *vbe_setPixel16(sScreenMode *mode,uint8_t *vidwork,uint8_t *color);
static uint8_t *vbe_setPixel24(sScreenMode *mode,uint8_t *vidwork,uint8_t *color);
static uint8_t *vbe_setPixel32(sScreenMode *mode,uint8_t *vidwork,uint8_t *color);
